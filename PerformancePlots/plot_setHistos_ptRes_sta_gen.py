...
p_ptResFitSigma_sta_glb_gen_eta, p_ptResFitSigma_sta_glb_gen_eta_label, p_ptResFitSigma_sta_glb_gen_eta_title, p_ptResFitSigma_sta_glb_gen_eta_x, p_ptResFitSigma_sta_glb_gen_eta_y = [], "ptResFitSigma_sta_glb_gen_eta", "p_{T} res. for #mu_{STA} (p_{T}>30 GeV)", "#eta", "#sigma(q/p_{T STA} - q/p_{T GEN}) [1/GeV]"
...
p_ptResFitMean_sta_glb_gen_eta, p_ptResFitMean_sta_glb_gen_eta_label, p_ptResFitMean_sta_glb_gen_eta_title, p_ptResFitMean_sta_glb_gen_eta_x, p_ptResFitMean_sta_glb_gen_eta_y = [], "ptResFitMean_sta_glb_gen_eta", "p_{T} res. mean for #mu_{STA} (p_{T}>30 GeV)", "#eta", "mean(q/p_{T STA} - q/p_{T GEN}) [1/GeV]"
...
p_ptResFitSigma_sta_glb_gen_phi, p_ptResFitSigma_sta_glb_gen_phi_label, p_ptResFitSigma_sta_glb_gen_phi_title, p_ptResFitSigma_sta_glb_gen_phi_x, p_ptResFitSigma_sta_glb_gen_phi_y = [], "ptResFitSigma_sta_glb_gen_phi", "p_{T} res. for #mu_{STA} (p_{T}>30 GeV, |#eta|<2.4)", "#phi", "#sigma(q/p_{T STA} - q/p_{T GEN}) [1/GeV]"
...
p_ptResFitMean_sta_glb_gen_phi, p_ptResFitMean_sta_glb_gen_phi_label, p_ptResFitMean_sta_glb_gen_phi_title, p_ptResFitMean_sta_glb_gen_phi_x, p_ptResFitMean_sta_glb_gen_phi_y = [], "ptResFitMean_sta_glb_gen_phi", "p_{T} res. mean for #mu_{STA} (p_{T}>30 GeV, |#eta|<2.4)", "#phi", "mean(q/p_{T STA} - q/p_{T GEN}) [1/GeV]"
...
p_ptResFitSigma_sta_glb_genB_phi, p_ptResFitSigma_sta_glb_genB_phi_label, p_ptResFitSigma_sta_glb_genB_phi_title, p_ptResFitSigma_sta_glb_genB_phi_x, p_ptResFitSigma_sta_glb_genB_phi_y = [], "ptResFitSigma_sta_glb_genB_phi", "p_{T} res. for #mu_{STA} (p_{T}>30 GeV, |#eta|<0.9)", "#phi", "#sigma(q/p_{T STA} - q/p_{T GEN}) [1/GeV]"
...
p_ptResFitMean_sta_glb_genB_phi, p_ptResFitMean_sta_glb_genB_phi_label, p_ptResFitMean_sta_glb_genB_phi_title, p_ptResFitMean_sta_glb_genB_phi_x, p_ptResFitMean_sta_glb_genB_phi_y = [], "ptResFitMean_sta_glb_genB_phi", "p_{T} res. mean for #mu_{STA} (p_{T}>30 GeV, |#eta|<0.9)", "#phi", "mean(q/p_{T STA} - q/p_{T GEN}) [1/GeV]"
...
p_ptResFitMean_sta_glb_genEOp_phi, p_ptResFitMean_sta_glb_genEOp_phi_label, p_ptResFitMean_sta_glb_genEOp_phi_title, p_ptResFitMean_sta_glb_genEOp_phi_x, p_ptResFitMean_sta_glb_genEOp_phi_y = [], "ptResFitMean_sta_glb_genEOp_phi", "p_{T} res. mean for #mu_{STA} (p_{T}>30 GeV, 0.9<#eta<2.4)", "#phi", "mean(q/p_{T STA} - q/p_{T GEN}) [1/GeV]"
...
p_ptResFitSigma_sta_glb_genEOm_phi, p_ptResFitSigma_sta_glb_genEOm_phi_label, p_ptResFitSigma_sta_glb_genEOm_phi_title, p_ptResFitSigma_sta_glb_genEOm_phi_x, p_ptResFitSigma_sta_glb_genEOm_phi_y = [], "ptResFitSigma_sta_glb_genEOm_phi", "p_{T} res. for #mu_{STA} (p_{T}>30 GeV, -2.4<#eta<-0.9)", "#phi", "#sigma(q/p_{T STA} - q/p_{T GEN}) [1/GeV]"
